...
from scrappers.items import SriItem
...
class SriSpider(Spider):
    ...
    custom_settings = {
        ...
        'ITEM_PIPELINES' : {
            "scrappers.pipelines.PreprocessDataPipeline": 300,
            "scrappers.pipelines.SaveToMySQLPipeline": 400
        }
    }
    ...
    def response_data(self, response):
        ...
        if data.get('suspendidas', ''):
            ...
            sri_item['message'] = 'El ciudadano / contribuyente no registra deudas firmes, impugnadas o en facilidades de pago.'
